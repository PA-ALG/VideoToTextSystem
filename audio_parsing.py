...
class AudioParser:
    ...
    def __init__(self, audio_in, output_dir):
        ...
        self.inference_pipeline = pipeline(
            ...
            model='/root/.cache/modelscope/hub/damo/speech_paraformer-large-vad-punc-spk_asr_nat-zh-cn',
            model_revision='v0.0.2',
            vad_model='/root/.cache/modelscope/hub/damo/speech_fsmn_vad_zh-cn-16k-common-pytorch',
            punc_model='/root/.cache/modelscope/hub/damo/punc_ct-transformer_cn-en-common-vocab471067-large',
...
def main(i):
    ...
    for dir in file_list_circle:
        ...
        if files_count == 1:
            ...
            try:
                if not os.path.exists('files/results' + '/' + dir + '/' + dir + '/1best_recog/text_with_punc'):
                    # 视频转为文本
                ...
                if not os.path.exists('files/results' + '/' + dir + '/' + dir):
                    os.mkdir('files/results' + '/' + dir + '/' + dir)
